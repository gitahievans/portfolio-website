...
import codeLottie from '../assets/animation_lkas2y9e.json'
...
const Hero = () => {
    return (
        <section className='px-2 md:px-5 lg:px-0 lg:max-w-[85%] mx-auto flex flex-col lg:flex-row gap-6 items-center justify-center h-screen'>
            <div className="lg:w-1/2 flex flex-col gap-6 md:gap-10 dark:text-gray-300">
                <h1 className="font-name-font font-extrabold text-purple-700">I am Evans</h1>
            ...
            <div className=" flex lg:w-1/2 h-full border">
                <Lottie animationData={codeLottie} />
            </div>
        </section>
    )
}
