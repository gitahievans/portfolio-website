...
const Skills = () => {
  return (
    <div className="flex flex-col items-center justify-center">
      ...
      <h2 className="font-primary font-bold text-4xl text-center text-primary">evans.skills</h2>


      <div className="w-full grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 md:gap-4 place-items-center">
