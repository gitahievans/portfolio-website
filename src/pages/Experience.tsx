...
import { contributedProjects } from "../../Constants/constants";

const Experience = () => {
    const [showMore, setShowMore] = useState<boolean>(false);

    return (
        <section className='px-2 md:px-5 lg:px-0 lg:max-w-[85%] mx-auto flex flex-col gap-6 items-center justify-center md:justify-start min-h-screen md:pt-10'>
            ...
            <div className="flex flex-col lg:flex-row gap-6 items-center lg:justify-center ">
                ...
                <div className="flex flex-col gap-6 md:w-4/5 lg:w-1/2 ">
                    <div className="flex flex-col items-center gap-3 w-full ">
                        <h1 className="font-semibold uppercase text-sm dark:text-gray-300 ">Work Experience</h1>
                    ...
                    <div className="flex flex-col items-center gap-3 ">
                        <h1 className="font-semibold uppercase text-sm dark:text-gray-300">Project Contributions</h1>
                        {
                            contributedProjects.map(project => (
                                <ProjectContribution key={crypto.randomUUID()} project={project}/>
                            ))
                        }
                    </div>
                </div>
